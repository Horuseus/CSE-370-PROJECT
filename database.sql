...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2026 at 06:44 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `donor_login` (IN `p_name` VARCHAR(100), IN `p_pass` VARCHAR(255), OUT `p_result` VARCHAR(50))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ngo_login` (IN `p_name` VARCHAR(100), IN `p_pass` VARCHAR(255), OUT `p_result` VARCHAR(50))   BEGIN
    DECLARE v_exists INT DEFAULT 0;
    DECLARE v_pass_match INT DEFAULT 0;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `refugee_login` (IN `p_name` VARCHAR(100), IN `p_pass` VARCHAR(255), OUT `p_result` VARCHAR(50))   BEGIN
    DECLARE v_exists INT DEFAULT 0;
    DECLARE v_pass_match INT DEFAULT 0;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `volunteer_login` (IN `p_name` VARCHAR(100), IN `p_pass` VARCHAR(255), OUT `p_result` VARCHAR(50))   BEGIN
    DECLARE v_exists INT DEFAULT 0;
    DECLARE v_pass_match INT DEFAULT 0;
...
('ASN-335F9B', 'VOL002', '2026-04-29', 'CAMP004'),
('ASN-A915DA', 'VOL-91F77DDD', '2026-04-29', 'CAMP005'),
('ASN-AE87D6', 'VOL003', '2026-04-29', 'CAMP001');
...
('ASGN007', 'Education'),
('ASN-335F9B', 'General Labour'),
('ASN-A915DA', 'Education & Child Care'),
('ASN-AE87D6', 'Education & Child Care');
...
('CAMP001', 'Cox\'s Bazar, Bangladesh', 50000, 'VOL001', NULL),
('CAMP002', 'Zaatari, Jordan', 80000, 'VOL003', NULL),
('CAMP003', 'Kakuma, Kenya', 60000, 'VOL004', NULL),
('CAMP004', 'Dadaab, Kenya', 90000, 'VOL002', NULL),
('CAMP005', 'Azraq, Jordan', 40000, 'VOL005', NULL),
('CAMP006', 'Bidi Bidi, Uganda', 270000, 'VOL006', NULL),
('CAMP007', 'Kutupalong, Bangladesh', 600000, 'VOL009', NULL),
('CAMP008', 'Nakivale, Uganda', 80000, 'VOL015', NULL);
...
('INV002', 'Bandages', 'CAMP001'),
('INV010', 'Oxygen Cylinders', 'CAMP001'),
('INV003', 'Oral Rehydration', 'CAMP002'),
...
--
-- Dumping data for table `camp_medical_inventory_asks_for`
--

INSERT INTO `camp_medical_inventory_asks_for` (`Requesting_Inventory_id`, `Requested_Inventory_id`, `Item_needed`, `Units`, `Status`) VALUES
('INV004', 'INV006', 'Syringes', 100, 0),
('INV005', 'INV003', 'Oral Rehydration', 300, 1),
('INV007', 'INV001', 'Paracetamol', 500, 0),
('INV008', 'INV002', 'Bandages', 200, 1),
('INV013', 'INV003', 'Oral Rehydration', 500, 0),
('INV014', 'INV002', 'Bandages', 300, 1),
('INV015', 'INV004', 'Antibiotics', 30, 0),
('INV018', 'INV005', 'Insulin', 20, 0),
('INV019', 'INV009', 'Blood Bags', 50, 1);
...
INSERT INTO `evac_request` (`Evareq_id`, `Status`, `Priority`, `Request_date`, `Allocation_date`, `Vehicle_id`, `Safr_id`, `Operating_areas`) VALUES
('EVA-D7D81372', 0, 'medium', '2026-04-29', NULL, NULL, 'SAFR260429A91DE182', 'Aleppo'),
('EVAC001', 1, 'Elder', '2024-02-05', '2024-02-05', 'VEH001', 'SAFR-C1-20240101-001', 'Cox\'s Bazar'),
('EVAC002', 1, 'Chronically Ill', '2024-02-10', '2024-02-10', 'VEH002', 'SAFR-C3-20240201-001', 'Kakuma'),
('EVAC003', 0, 'Minor', '2024-03-01', NULL, 'VEH003', 'SAFR-C2-20240115-002', 'Zaatari'),
('EVAC004', 0, 'General', '2024-03-10', NULL, 'VEH004', 'SAFR-C4-20240210-001', 'Dadaab'),
('EVAC005', 1, 'Elder', '2024-03-15', '2024-03-15', 'VEH006', 'SAFR-C5-20240220-001', 'Azraq'),
('EVAC006', 1, 'Minor', '2024-02-15', '2024-02-15', 'VEH007', 'SAFR-C6-20240101-003', 'Bidi Bidi'),
('EVAC007', 1, 'Elder', '2024-02-20', '2024-02-20', 'VEH008', 'SAFR-C7-20240110-004', 'Kutupalong'),
('EVAC008', 0, 'General', '2024-03-05', NULL, 'VEH009', 'SAFR-C7-20240110-002', 'Kutupalong'),
('EVAC009', 1, 'Chronically Ill', '2024-03-12', '2024-03-12', 'VEH010', 'SAFR-C8-20240120-001', 'Nakivale'),
('EVAC010', 0, 'Minor', '2024-03-20', NULL, 'VEH011', 'SAFR-C6-20240101-003', 'Uganda'),
('EVAC011', 1, 'General', '2024-04-01', '2024-04-01', 'VEH012', 'SAFR-C7-20240315-005', 'Bangladesh');
...
('INV002', 'Bandages', '2024-03-01'),
('INV003', 'Oral Rehydration', '2024-03-05'),
...
('INV010', 'Oxygen Cylinders', '2024-03-15'),
...
('INV002', 'Bandages', 2000),
('INV003', 'Oral Rehydration', 1500),
...
('SAFR260429A91DE182', 'Tharim joy', '1994-10-12', '', 'Bankok', 'Pattaya', '2026-04-29');
...
('SAFR260429A91DE182', 'ZsN0n@@@');

-- --------------------------------------------------------

--
-- Table structure for table `refugee_has_requested_vehicle`
--

CREATE TABLE `refugee_has_requested_vehicle` (
  `Safr_id` varchar(20) NOT NULL,
  `Vehicle_id` varchar(20) NOT NULL,
  `Destination_camp` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `refugee_has_requested_vehicle`
--

INSERT INTO `refugee_has_requested_vehicle` (`Safr_id`, `Vehicle_id`, `Destination_camp`) VALUES
('SAFR-C1-20240101-001', 'VEH001', 'CAMP004'),
('SAFR-C2-20240115-002', 'VEH003', 'CAMP005'),
('SAFR-C3-20240201-001', 'VEH002', 'CAMP004'),
('SAFR-C5-20240220-001', 'VEH006', 'CAMP002'),
('SAFR-C6-20240101-003', 'VEH007', 'CAMP008'),
('SAFR-C7-20240110-004', 'VEH008', 'CAMP001'),
('SAFR-C7-20240315-005', 'VEH012', 'CAMP002'),
('SAFR-C8-20240120-001', 'VEH010', 'CAMP006');
...
('SAFR260429A91DE182', 1, 'Adut Deng', 'SEARCH-DOC', 'SAFR-C6-20240310-004');
...
INSERT INTO `vehicle` (`Vehicle_id`, `Vehicle_type`, `Capacity`, `Operating_Areas`, `Camp_id`) VALUES
('VEH001', 'Bus', 45, 'Cox\'s Bazar Region', 'CAMP001'),
('VEH002', 'Ambulance', 4, 'Cox\'s Bazar Region', 'CAMP001'),
('VEH003', 'Truck', 20, 'Zaatari Region', 'CAMP002'),
('VEH004', 'Bus', 45, 'Kakuma Region', 'CAMP003'),
('VEH005', 'Ambulance', 4, 'Dadaab Region', 'CAMP004'),
('VEH006', 'Helicopter', 10, 'Jordan Region', 'CAMP005'),
('VEH007', 'Bus', 45, 'Bidi Bidi Region', 'CAMP006'),
('VEH008', 'Ambulance', 4, 'Kutupalong Region', 'CAMP007'),
('VEH009', 'Truck', 20, 'Kutupalong Region', 'CAMP007'),
('VEH010', 'Ambulance', 4, 'Nakivale Region', 'CAMP008'),
('VEH011', 'Helicopter', 10, 'Uganda Region', 'CAMP006'),
('VEH012', 'Bus', 60, 'Bangladesh Region', 'CAMP007');
...
INSERT INTO `volunteer` (`Volunteer_id`, `Name`, `Email`, `Phone`, `Home_Country`) VALUES
('VOL-3B783429', 'Wahid', 'abkmajlis@gmail.com', '01716659908', 'Bangladesh'),
('VOL-91F77DDD', 'shopnil', 'tarc67mem@gmail.com', '01715009641', 'Bangladesh'),
('VOL001', 'Ahmed Hassan', 'ahmed.hassan@email.com', '+880-1711-111001', 'Bangladesh'),
('VOL002', 'Maria Santos', 'maria.santos@email.com', '+63-917-222002', 'Philippines'),
('VOL003', 'Fatima Al-Rashid', 'fatima.rashid@email.com', '+962-79-333003', 'Jordan'),
('VOL004', 'James Okonkwo', 'james.okonkwo@email.com', '+234-803-444004', 'Nigeria'),
('VOL005', 'Priya Sharma', 'priya.sharma@email.com', '+91-98765-55005', 'India'),
('VOL006', 'Amina Yusuf', 'amina.yusuf@email.com', '+254-722-666006', 'Kenya'),
('VOL007', 'Carlos Rivera', 'carlos.rivera@email.com', '+52-55-777007', 'Mexico'),
('VOL008', 'Lena Fischer', 'lena.fischer@email.com', '+49-176-888008', 'Germany'),
('VOL009', 'Omar Farouk', 'omar.farouk@email.com', '+20-100-999009', 'Egypt'),
('VOL010', 'Sarah Mitchell', 'sarah.mitchell@email.com', '+1-617-100010', 'USA'),
('VOL011', 'Tariq Mahmoud', 'tariq.mahmoud@email.com', '+966-50-111011', 'Saudi Arabia'),
('VOL012', 'Hana Kim', 'hana.kim@email.com', '+82-10-222012', 'South Korea'),
('VOL013', 'Blessing Eze', 'blessing.eze@email.com', '+234-806-333013', 'Nigeria'),
('VOL014', 'Rania Aziz', 'rania.aziz@email.com', '+216-20-444014', 'Tunisia'),
('VOL015', 'David Ochieng', 'david.ochieng@email.com', '+254-733-555015', 'Kenya');
...
INSERT INTO `volunteers_quota` (`Volunteer_id`, `Outcome`) VALUES
('VOL001', 'Successfully administered medical aid to 200 refugees'),
('VOL002', 'Dadafdwwdd'),
('VOL003', 'Coordinated supply delivery for 3 camp zones'),
('VOL004', 'Provided emergency medical care during outbreak'),
('VOL005', 'Conducted 80 counselling sessions');
...
('VOL-3B783429', '1234567'),
('VOL-91F77DDD', '1234567'),
('VOL001', 'ahmed123'),
('VOL002', 'maria456'),
('VOL003', 'fatima789'),
('VOL004', 'james321');
...
--
-- Indexes for table `refugee_has_requested_vehicle`
--
ALTER TABLE `refugee_has_requested_vehicle`
  ADD PRIMARY KEY (`Safr_id`,`Vehicle_id`),
  ADD KEY `Vehicle_id` (`Vehicle_id`);
...
ALTER TABLE `refugee_stay_in_camp`
  ADD PRIMARY KEY (`Safr_id`,`Camp_id`),
  ADD KEY `Camp_id` (`Camp_id`);
...
--
ALTER TABLE `aid`
  ADD CONSTRAINT `aid_ibfk_1` FOREIGN KEY (`Camp_id`) REFERENCES `camp` (`Camp_id`),
  ADD CONSTRAINT `aid_ibfk_2` FOREIGN KEY (`NGO_name`) REFERENCES `ngo` (`NGO_name`);

--
-- Constraints for table `assignment`
--
ALTER TABLE `assignment`
  ADD CONSTRAINT `assignment_ibfk_1` FOREIGN KEY (`Volunteer_id`) REFERENCES `volunteer` (`Volunteer_id`),
  ADD CONSTRAINT `assignment_ibfk_2` FOREIGN KEY (`Camp_id`) REFERENCES `camp` (`Camp_id`);

--
-- Constraints for table `assignment_required_skill`
--
ALTER TABLE `assignment_required_skill`
  ADD CONSTRAINT `assignment_required_skill_ibfk_1` FOREIGN KEY (`Assignment_ID`) REFERENCES `assignment` (`Assignment_ID`);

--
-- Constraints for table `camp`
--
ALTER TABLE `camp`
  ADD CONSTRAINT `camp_ibfk_1` FOREIGN KEY (`Volunteer_id`) REFERENCES `volunteer` (`Volunteer_id`),
  ADD CONSTRAINT `fk_camp_evareq` FOREIGN KEY (`Evareq_id`) REFERENCES `evac_request` (`Evareq_id`);

--
-- Constraints for table `camp_medical_inventory`
--
ALTER TABLE `camp_medical_inventory`
  ADD CONSTRAINT `camp_medical_inventory_ibfk_1` FOREIGN KEY (`Camp_id`) REFERENCES `camp` (`Camp_id`);

--
-- Constraints for table `camp_medical_inventory_asks_for`
--
ALTER TABLE `camp_medical_inventory_asks_for`
  ADD CONSTRAINT `camp_medical_inventory_asks_for_ibfk_1` FOREIGN KEY (`Requesting_Inventory_id`) REFERENCES `camp_medical_inventory` (`Inventory_id`),
  ADD CONSTRAINT `camp_medical_inventory_asks_for_ibfk_2` FOREIGN KEY (`Requested_Inventory_id`) REFERENCES `camp_medical_inventory` (`Inventory_id`);

--
-- Constraints for table `camp_request`
--
ALTER TABLE `camp_request`
  ADD CONSTRAINT `camp_request_ibfk_1` FOREIGN KEY (`Camp_id`) REFERENCES `camp` (`Camp_id`),
  ADD CONSTRAINT `camp_request_ibfk_2` FOREIGN KEY (`NGO_name`) REFERENCES `ngo` (`NGO_name`);

--
-- Constraints for table `donor_credential`
--
ALTER TABLE `donor_credential`
  ADD CONSTRAINT `donor_credential_ibfk_1` FOREIGN KEY (`Full_name`) REFERENCES `donor` (`Name`);

--
-- Constraints for table `donor_ngo`
--
ALTER TABLE `donor_ngo`
  ADD CONSTRAINT `donor_ngo_ibfk_1` FOREIGN KEY (`NGO_name`) REFERENCES `ngo` (`NGO_name`),
  ADD CONSTRAINT `donor_ngo_ibfk_2` FOREIGN KEY (`Donor_Name`) REFERENCES `donor` (`Name`);

--
-- Constraints for table `evac_request`
--
ALTER TABLE `evac_request`
  ADD CONSTRAINT `evac_request_ibfk_1` FOREIGN KEY (`Vehicle_id`) REFERENCES `vehicle` (`Vehicle_id`),
  ADD CONSTRAINT `evac_request_ibfk_2` FOREIGN KEY (`Safr_id`) REFERENCES `refugee` (`Safr_id`);

--
-- Constraints for table `identity_doc`
--
ALTER TABLE `identity_doc`
  ADD CONSTRAINT `identity_doc_ibfk_1` FOREIGN KEY (`Safr_id`) REFERENCES `refugee` (`Safr_id`);

--
-- Constraints for table `inventory_update`
--
ALTER TABLE `inventory_update`
  ADD CONSTRAINT `inventory_update_ibfk_1` FOREIGN KEY (`Inventory_id`,`Item_name`) REFERENCES `camp_medical_inventory` (`Inventory_id`, `Item_name`);

--
-- Constraints for table `item_amount`
--
ALTER TABLE `item_amount`
  ADD CONSTRAINT `item_amount_ibfk_1` FOREIGN KEY (`Inventory_id`,`Item_name`) REFERENCES `camp_medical_inventory` (`Inventory_id`, `Item_name`);

--
-- Constraints for table `match_details`
--
ALTER TABLE `match_details`
  ADD CONSTRAINT `match_details_ibfk_1` FOREIGN KEY (`Safr_id`) REFERENCES `refugee` (`Safr_id`);

--
-- Constraints for table `ngo`
--
ALTER TABLE `ngo`
  ADD CONSTRAINT `ngo_ibfk_1` FOREIGN KEY (`Camp_id`) REFERENCES `camp` (`Camp_id`);

--
-- Constraints for table `ngo_credential`
--
ALTER TABLE `ngo_credential`
  ADD CONSTRAINT `ngo_credential_ibfk_1` FOREIGN KEY (`NGO_name`) REFERENCES `ngo` (`NGO_name`);

--
-- Constraints for table `ngo_inventory`
--
ALTER TABLE `ngo_inventory`
  ADD CONSTRAINT `ngo_inventory_ibfk_1` FOREIGN KEY (`NGO_name`) REFERENCES `ngo` (`NGO_name`);

--
-- Constraints for table `refugee_credential`
--
ALTER TABLE `refugee_credential`
  ADD CONSTRAINT `refugee_credential_ibfk_1` FOREIGN KEY (`Safr_id`) REFERENCES `refugee` (`Safr_id`);

--
-- Constraints for table `refugee_has_requested_vehicle`
--
ALTER TABLE `refugee_has_requested_vehicle`
  ADD CONSTRAINT `refugee_has_requested_vehicle_ibfk_1` FOREIGN KEY (`Safr_id`) REFERENCES `refugee` (`Safr_id`),
  ADD CONSTRAINT `refugee_has_requested_vehicle_ibfk_2` FOREIGN KEY (`Vehicle_id`) REFERENCES `vehicle` (`Vehicle_id`);

--
-- Constraints for table `refugee_stay_in_camp`
--
ALTER TABLE `refugee_stay_in_camp`
  ADD CONSTRAINT `refugee_stay_in_camp_ibfk_1` FOREIGN KEY (`Safr_id`) REFERENCES `refugee` (`Safr_id`),
  ADD CONSTRAINT `refugee_stay_in_camp_ibfk_2` FOREIGN KEY (`Camp_id`) REFERENCES `camp` (`Camp_id`);

--
-- Constraints for table `search_req`
--
ALTER TABLE `search_req`
  ADD CONSTRAINT `search_req_ibfk_1` FOREIGN KEY (`Safr_id`) REFERENCES `refugee` (`Safr_id`),
  ADD CONSTRAINT `search_req_ibfk_2` FOREIGN KEY (`Safr_id`,`Doc_number`) REFERENCES `identity_doc` (`Safr_id`, `Doc_number`),
  ADD CONSTRAINT `search_req_ibfk_3` FOREIGN KEY (`Match_Safr_id`) REFERENCES `match_details` (`Safr_id`);

--
-- Constraints for table `vehicle`
--
ALTER TABLE `vehicle`
  ADD CONSTRAINT `vehicle_ibfk_1` FOREIGN KEY (`Camp_id`) REFERENCES `camp` (`Camp_id`);

--
-- Constraints for table `volunteers_quota`
--
ALTER TABLE `volunteers_quota`
  ADD CONSTRAINT `volunteers_quota_ibfk_1` FOREIGN KEY (`Volunteer_id`) REFERENCES `assignment` (`Volunteer_id`);

--
-- Constraints for table `volunteer_credential`
--
ALTER TABLE `volunteer_credential`
  ADD CONSTRAINT `volunteer_credential_ibfk_1` FOREIGN KEY (`Volunteer_id`) REFERENCES `volunteer` (`Volunteer_id`);
COMMIT;
