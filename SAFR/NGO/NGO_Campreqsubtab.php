...
<head>
    ...
    <title>Camp Requests – SAFR</title>
...
<div class="safr-container wide">
    ...
    <table class="safr-table">
        ...
        <?php if (mysqli_num_rows($result) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <tr><td colspan="4">No camp requests found.</td></tr>
        <?php endif; ?>
        </tbody>
    </table>
    ...
    <div style="margin-top:24px;">
        <form action="reqaccepttab.php" method="post">
            <button type="submit" class="safr-btn">Accept Request</button>
        </form>
    </div>
</div>
